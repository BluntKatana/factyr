...
with open('./Pickle/dict_query_train_ent.pkl', 'rb') as f:
    dict_query_train_ent = pickle.load(f)
with open('./Pickle/dict_query_dev_ent.pkl', 'rb') as f:
    dict_query_dev_ent = pickle.load(f)
with open('./Pickle/dict_query_test_ent.pkl', 'rb') as f:
    dict_query_test_ent = pickle.load(f)
with open('./Pickle/dict_ctx_ent.pkl', 'rb') as f:
    dict_ctx_ent = pickle.load(f)
with open('./Pickle/dict_set_query_train_ent.pkl', 'rb') as f:
    dict_set_query_train_ent = pickle.load(f)
with open('./Pickle/dict_set_query_dev_ent.pkl', 'rb') as f:
    dict_set_query_dev_ent = pickle.load(f)
with open('./Pickle/dict_set_query_test_ent.pkl', 'rb') as f:
...
# +
with open('./Pickle/entity_TFIDF.pkl', 'wb') as f:
