...
# text2 = """Italy ( Italian : Roma ) is the capital of Italy and the administrative center of the Lazio region and the Città Metropolitana di Roma Capitale (formerly the Province of Rome ). The city has approximately 2.9 million inhabitants, the population of the metropolitan region is 4.4 million. It is the largest city in Italy. The Tiber and Aniene flow through the city, located in the midwest of the Apennine Peninsula . Worth seeing are the Colosseum , the Roman Forum , the Pantheon , St. Peter's Basilica , the Trevi Fountain and the Monument to Victor Emanuel II ."""


# <---------------------------Step 3: Perform Triple Extraction -------------------------------->

# extracted_triples_query = TripleExtraction.extract_openie_triples(query)
# print("Extracted Triple:", extracted_triples_query)

# <---------------------------Step 4: Calculate percentage from extracted triples ------------------------------->
percentageEntity = calculatePercentage.calculate_percentage(is_rome_capital_of_italy, wiki_of_rome, wiki_of_italy)
...
# <--------------------------- Final check --------------------------->
if result and percentageEntity > 30:
